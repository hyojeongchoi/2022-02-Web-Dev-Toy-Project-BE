...
// 댓글 등록 API
router.post('/:postId', authenticateAccessToken, async (req, res) => {
  try {
    const postId = Number(req.params.postId);
...
// 댓글 수정 API
router.put('/:postId/:commentId', authenticateAccessToken, async (req, res) => {
  try {
...
// 댓글 삭제 API
router.delete('/:postId/:commentId', authenticateAccessToken, async (req, res) => {
  try {
    const postId = Number(req.params.postId);
    const commentId = Number(req.params.commentId);
    const userId = req.user.id;
